...
## Changelog
- 2026-09-17 (Grok chat): HOF now was the logistic at score 0 (~2%) painted on every empty resume. One season with no All-Star is not a 2% Hall ticket. Empty resume uses draft-night; 8 years never an All-Star is 0.

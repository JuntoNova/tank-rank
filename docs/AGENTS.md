...
## Changelog
- 2026-09-17 (Grok chat): Both handle theories on every card. Passers = ast when present. Tall passer = 6-7+ and 2.2+ ast, no hidden create tag. Missing assists skip (×1.00).

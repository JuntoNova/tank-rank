...
## Changelog
- 2026-09-17 (Grok chat): All 9 size claims now have a scoring path. Height is one number (the two charts are the same measurement). Weight, pounds-per-inch, wingspan, ape, standing reach, size-at-position, and swing fire when the file has them and skip when they do not. Reach was never parsed (8-10 is 106 inches). Swing was zeroed. No inventing missing combine numbers.

...
## Changelog
- 2026-09-17 (Grok chat): Intl counting stats below a college mean are not a college line (Risacher 10.1 at JL Bourg). Skip them. Yao 32.4 still fires. Career Yrs=2 is seasons played, not the forecast.

...
- 2026-09-14 (Grok chat): HOF odds were too hot (Dybantsa 47%, lottery 14–35%). All-time Springfield slot rates (~2.4 expected per draft) plus youth stacking. theory-model now scales slot pHof by 0.40, caps any player at 20%, and keeps age from also multiplying HOF hard. Size 7-3 still lifts relative to the same pick. Do not restore 34% #1 HOF as the painted number.

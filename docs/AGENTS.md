...
## Changelog
- 2026-09-17 (Grok chat): Age page dropped pick-conditioned claims (same pick, first round, era). Three pick-free checks: younger last longer, younger develop better, older contribute faster and stick. Data: young win years and honors. Old do not win WS/year or 3-year rate. Slot is not in the table.

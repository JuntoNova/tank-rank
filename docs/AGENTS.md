...
- 2026-09-14 (Grok chat): Player theory table matches the board columns (AS / 1st / All-NBA / Yrs / Chips / MVP / HOF). Rows are player theories only — no Draft slot, no Why commentary. Each row is the running projection after that theory. Do not paint slot-prior years as the hero on completed careers (1947–2025).

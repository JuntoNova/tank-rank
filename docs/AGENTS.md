...
## Changelog
- 2026-09-17 (Grok chat): HOF was 0.34 × P(ever AS). That is P(HOF|multi All-Star) leaking onto 1-timers. One-time All-Stars are 3.5% HOF, 2+ are 49%. Draft-night P(2+) ≈ P(AS)^2. LaRavia 4% → ~1.8%. Class expected HOF ~0.55. Cap 15%.

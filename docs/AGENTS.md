...
## Changelog
- 2026-09-17 (Grok chat): Age is not its own hub category. One live theory: drafting younger is better (years + All-Star). Older-higher-floor is Disproven with the WS/year and 3-year table, and it is not on the player card.

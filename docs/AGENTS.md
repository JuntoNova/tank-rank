...
## Changelog
- 2026-09-17 (Grok chat): Handle page. Dropped first-round / pick table. Collapsed two tall-passer tables into one (same height, high vs low ast). Passers-in-general stays.

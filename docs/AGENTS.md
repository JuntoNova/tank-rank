...
## Changelog
- 2026-09-17 (Grok chat): Hub families are theories, not cabinets. Body is gone. "You can't teach size" is the physical theory (size page + handle + combine). "Drafting younger is better" is its own one-theory family. late and jump moved to Disproven. one-and-done is age, not a second lever.
